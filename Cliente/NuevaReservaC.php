...
try {
    ...
    echo "<form id='login' name='login' method='POST' action='reservaClienteNuevo.php'>";
      ...
      echo "<div class='form-group'>";
        ...
        echo "<input type='text' name='nombre' class='form-control' placeholder='Nombre...' required=''>";
      echo "</div>";
      echo "<div class='form-group'>";
        echo "<label for='celular'>Celular Cliente</label>";
        echo "<input type='text' name='celular' class='form-control' placeholder='Celular...' onkeypress='return validar(event)' required=''>";
      echo "</div>";
    echo "<div class='form-group'>";
    ...
    echo "<div class='form-group'>";
      ...
      echo "<div class='form-group'>";
        ...
        echo "<input type='text' name='diaReserva' class='form-control' disabled value='".$hoy."' required=''>";
