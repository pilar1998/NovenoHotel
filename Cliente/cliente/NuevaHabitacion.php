...
try {
    ...
    $return = $client->AgregarHabitacion($params);
   echo "<!DOCTYPE html>";
    echo"    <html>";
    echo"<head>";
    ...
    echo "<h2>Hotel</h2>";
    echo "<h3>Habitacion Agregada</h3>";
    ...
    echo "<a href='ListarHabitaciones.php'><button class='btn btn-lg btn-info' type='button' href='ListarHabitaciones.php'name='boton' value='Nueva Reservacion'> <span class='fa fa-eye'></span> Ver Habitaciones</button></a>";
    echo "</div>   ";
    echo "<!-- jQuery 2.1.4 -->";
